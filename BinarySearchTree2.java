...
//====================================================
 ...
 //====================================================
   ...
   //====================================================
   private void display_pre(Node root)
   {
        if(root!=null){
         System.out.print(" " + root.data);
         display(root.left);
   ...
   {
        BinarySearchTree5 b = new BinarySearchTree5();
        b.insert(4);b.insert(8);
        b.insert(1);b.insert(6);b.insert(3);b.insert(2);b.insert(10);
