...
//====================================================
   public boolean find(int id)
   {
        ...
        while(current!=null){
         if(current.data==id){
            ...
            return find(id, current.left);
         }else{
            return find(id, current.right);
         }
        }
        return false;
   }
   
   private boolean find(int id, Node n)
        {
        if (n == null) 
         return false;
	     if (n.data == id)
         return true;
	     if (id < n.data)
	   	return find(id, n.left);
	     else
         return find(id, n.right);
         }
 ...
 //====================================================
   ...
   {
        BinarySearchTree3 b = new BinarySearchTree3();
